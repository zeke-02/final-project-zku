...
cp ./circuit_cpp/circuit.wasm ./circuit.wasm
cp ./circuit_cpp/generate_witness.js ./generate_witness.js
cp ./circuit_cpp/witness_calculator.js ./witness_calculator.js
